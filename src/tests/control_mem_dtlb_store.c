...
// Doesn't work on older gem5
// cd /code/gem5-docker/util/m5 && scons build/X86/out/m5;
// gcc -I/code/gem5-docker/util/m5 -S -O0 control_mem_dtlb_store.c -L/code/gem5-docker/util/m5 -lm5 -o control_mem_dtlb_store.asm;

// gcc -S -O0 control_mem_dtlb_store.c -o control_mem_dtlb_store.asm;
